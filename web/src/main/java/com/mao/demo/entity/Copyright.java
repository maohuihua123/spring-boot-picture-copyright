...
public class Copyright {
    ...
    public Copyright(Tuple5<BigInteger, String, String, String, BigInteger> tuple) {
        ...
        this.createTime = simpleDateFormat.format(tuple.component5().multiply(BigInteger.valueOf(1000)));
    }
    ...
    public Copyright(Tuple6<BigInteger, String, String, String, String, BigInteger> tuple){
        ...
        this.createTime = simpleDateFormat.format(tuple.component6().multiply(BigInteger.valueOf(1000)));
    }
}
